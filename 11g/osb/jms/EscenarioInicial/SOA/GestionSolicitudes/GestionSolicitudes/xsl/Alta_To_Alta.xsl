...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="WSDL">
      ...
      <rootElement name="Alta" namespace="http://www.example.org/GestionSolicitudes/"/>
    </source>
  </mapSources>
  <mapTargets>
    <target type="WSDL">
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 140401.1420.0097) AT [WED MAY 20 12:58:19 CEST 2015]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <tns:Alta>
      <xsl:value-of select="/tns:Alta"/>
      <idpedido>
        <xsl:value-of select="/tns:Alta/idpedido"/>
      </idpedido>
      <xsl:for-each select="/tns:Alta/productos">
        <productos>
          <xsl:value-of select="."/>
          <idProducto>
